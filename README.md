...
![timeline_toggle.png](.\assets\timeline_toggle.png)
...
1. Download "*Timeline_Toggle_Addon.tox*" from [Releases](https://github.com/sweetdream165/TouchDesigner-Timeline-Toggle/releases).
